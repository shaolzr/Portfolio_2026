...
export default function Hero() {
  return (
    <section className="pt-[200px] md:pt-[200px]">
      ...
      <div className="w-full aspect-[4/3] md:aspect-[2/1] lg:min-h-[80vh] relative overflow-hidden">
        <img
          src="https://res.cloudinary.com/dcsejrast/image/upload/v1771134698/copy_of_mira_e1ab8e.png"
          alt="Tencent"
